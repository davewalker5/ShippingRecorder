            ...
            while (!token.IsCancellationRequested)
            {
                ...
                if (item != null)
                {
                    ...
                    using (var scope = ServiceScopeFactory.CreateScope())
                    {
                        ...
                        var factory = scope.ServiceProvider.GetService<ShippingRecorderFactory>();
...
#pragma warning disable CS1998
        protected virtual async Task ProcessWorkItemAsync(T item, IShippingRecorderFactory factory)
        {
