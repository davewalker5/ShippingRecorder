...
{
    public abstract class ShippingRecorderControllerBase : Controller
    {
        ...
        public ShippingRecorderControllerBase(IPartialViewToStringRenderer renderer, ILogger logger)
        {
            _renderer = renderer;
            _logger = logger;
        }
