...
{
    [TestClass]
    public class VesselTypeExportTest
    {
        private readonly VesselType _location = DataGenerator.CreateVesselType();
        ...
        public void FromCsvRecordTest()
        {
            ...
            var exportable = ExportableVesselType.FromCsv(record);
        ...
        public async Task ExportTest()
        {
            ...
            await context.VesselTypes.AddAsync(_location);
            ...
            var exportable = ExportableVesselType.FromCsv(records[1]);
            Assert.AreEqual(_location.Name, exportable.Name);
        }
    }
}